      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            // Reference State
            // reference the starting point as where the car is or at the previous path end point
            double ref_x = car_x;
            double ref_y = car_y;
            double ref_yaw = deg2rad(car_yaw);


            // if previous size is almost empty, use the car as starting state
            if (prev_size < 2) {
              ...
              // Use the points that make the path tangent to the previous end point
            ...
            // Transform to local car coords, shift angle to 0. Math easier
            ...
            for (int i = 0; i <= 50 - previous_path_x.size(); i++) {
              ...
              // rotate back to global coordinate system from local car coord
